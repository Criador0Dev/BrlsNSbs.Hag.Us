...
echo Pass: @LuisEdits2022
curl -O https://raw.githubusercontent.com/Criador0Dev/BrlsNSbs.Hag.Us/main/Files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/Criador0Dev/BrlsNSbs.Hag.Us/main/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
